    ...
    <React.Fragment>
      ...
      >
        <div className="container-fluid">
          <div className="container mt-5 dashboard-marquee-box">
            <div className="row">
          ...
          <div>
            <div className="row">
              ...
              <div className="col-md-6">
                <div className="tab_content tab-data-table db-memeber-details-table">
                        ...
                        <tr>
                          ...
                          <React.Fragment>
                            ...
                            <td>
                              <svg
                                onClick={() => {
                                  copy(`${logInfo?.first_name}${logInfo?.last_name}`);
                        ...
                        <tr>
                          ...
                          <React.Fragment>
                            ...
                            <td>
                              <svg
                                onClick={() => {
                                  copy(FormatDate(logInfo?.joining_date));
                                  toast("Joining date has been  copied", {
                                    autoClose: 1000,
                                  });
                                }}
                                className="pw-icon-pass"
                        ...
                        <tr>
                          ...
                          <React.Fragment>
                            ...
                            <td>
                              <svg
                                onClick={() => {
                                  copy(`${logInfo?.country_code}${logInfo?.phone_number}`);
                          ...
                          <React.Fragment>
                            ...
                            <td>
                              <svg
                                onClick={() => {
                                  copy("Registeration");
                                  toast("Account Type code has been copied.", {
                                    autoClose: 1000,
                                  });
                                }}
                                className="pw-icon-pass"
